...
class ppaw_widget extends WP_Widget {
    ...
    if ($atts) {
      foreach ($atts as $att) {
        ...
        if (($agate == $gateword) && ($gateword != '' )) {
          ...
          if (($acapt != '') && ($capt_inc)) $html_capt = '<p class="ppaw-caption-' . $gateword . '-' . $aid . '' . $class . '">' . $acapt . '</p>';
          if (($adesc != '') && ($desc_inc)) $html_desc = '<p class="ppaw-description-' . $gateword . '-' . $aid . '' . $class . '">' . $adesc . '</p>';
          ...
          $html .= '<img class="ppaw-img-' . $gateword . '-' . $aid . '' . $class . '" src="' . $att_src[0] . '" alt="' . $atitle . '" title="' . $atitle . '" />';
  ...
  function form($instance){
    $defaults = array('title' => '', 'ppaw_gateword' => '', 'ppaw_class' => '');
